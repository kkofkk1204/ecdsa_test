...
function App() {
  ...
  const [feedback, setFeedback] = useState(`Click the button to mint your NFT.`);
  ...
  const claimNFTs = async () => {
    ...
    [
      ...
      '0xE620ADBF9C29A7E616E13bc65d7900f3C10E737a',
    ],)
    console.log(message)
    ...
    // const found = wl_name.find(element => element.toLowerCase() == blockchain.account);
    // if (typeof(found) == "undefined") {
    //   console.log("Non-WL");
    //   setFeedback("Sorry, You are not in the whitelist.");
    //   setClaimingNft(false);}
    // if (typeof(found) != "undefined") {console.log("wl");
